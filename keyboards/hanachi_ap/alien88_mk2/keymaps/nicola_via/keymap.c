...
[_BASE] = LAYOUT_90_ansi(
    ...
    KC_5,   KC_0,   KC_LCTL,   KC_LGUI, KC_LALT,     LCTL_T(KC_SPC),  NCL_ON,   MO(_SYS),  KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT ,
                                                     LT(_FN,JP_MHEN),  NCL_ON,    // Thumb Extension Keys
                                               KC_NO, MS_WHLL,MS_BTN3,MS_WHLR,KC_NO  //Wheel knobs is  not standard equipment
    ),
[_NICOLA] = LAYOUT_90_ansi(
    _______,         _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______,_______, NG_1,    NG_2,    NG_3,    NG_4,    NG_5,    KC_6,    KC_7,    KC_8,     KC_9,     KC_0 ,    KC_MINS,  _______,  _______,
    _______, _______,_______, NG_Q,    NG_W,    NG_E,    NG_R,    NG_T,    NG_Y,    NG_U,    NG_I,     NG_O,     NG_P,     KC_LBRC,  KC_RBRC,   KC_BSLS,
    _______, _______,_______, NG_A,    NG_S,    NG_D,    NG_F,    NG_G,    NG_H,    NG_J,    NG_K,     NG_L,     NG_SCLN,  NG_QUOT,  _______,
    _______, _______,_______, NG_Z,    NG_X,    NG_C,    NG_V,    NG_B,    NG_N,    NG_M,    NG_COMM,  NG_DOT,   NG_SLSH,  _______,  _______,
    _______, _______,_______, _______, _______,     NG_SHFTL,        NG_SHFTR, _______, _______, _______, _______, _______ ,
                                                           NCL_OFF, JP_HENK,
...
[_SYS] = LAYOUT_90_ansi(
    ...
    UG_TOGG, KC_NO  , KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
    UG_NEXT, UG_PREV,KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
    UG_HUEU, UG_HUED, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
    UG_SATU, UG_SATD, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
    UG_VALU, UG_VALD, KC_NO, KC_NO, QK_BOOT, KC_NO, KC_NO, KC_NO, KC_MRWD, KC_VOLD, KC_VOLU, KC_MNXT ,
                                                           KC_NO, KC_NO,
                                               KC_NO, KC_NO,KC_NO,KC_NO,KC_NO
    ),
};
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [_NICOLA]   = { ENCODER_CCW_CW(KC_TRNS, KC_TRNS) },
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    case NCL_OFF:
        if (record->event.pressed) {
            ...
            layer_on(_FN); // _FN をオン
        } else {
            layer_off(_FN); // _FN をオフ
