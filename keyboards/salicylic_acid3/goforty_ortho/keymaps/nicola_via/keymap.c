...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        KC_ESC,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    _______, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,     KC_MINS,
        KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    JP_LBRC, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_ENT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    JP_RBRC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_INT1,
        MO(2),   KC_GRV,  KC_LGUI, KC_LALT,   KC_INT5,   KC_SPC, NCL_ON,     KC_BSPC,    KC_RALT, KC_RGUI, _______, _______
    ),
    [1] = LAYOUT(
        _______, NG_Q,    NG_W,    NG_E,    NG_R,    NG_T,    _______, NG_Y,     NG_U,    NG_I,    NG_O,    NG_P,    NG_LBRC,
